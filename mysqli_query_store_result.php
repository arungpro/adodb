...
Drive load via a terminal:  
      while true; do sleep 1; curl http://localhost:8080/mysqli_query_store_result.php ; echo -e ‘\n\n\n\n’$(date);done
*/
$mysqli = mysqli_init();
/* connect to server */
...
if ($result = mysqli_query($mysqli, "SELECT * FROM employeestest where mscol='NO'", MYSQLI_STORE_RESULT)) {
