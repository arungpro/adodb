...
agentVersionId="20.11.0.4253GA.20.11.0.4253.75d600f2cb0e5bab2d162702ff8fae3cfba877cc"
...
if [ -n "${phpVersionId}" ] ; then
    case "${phpVersionId}" in
        ...
        *)
            ...
            fatal_error "PHP Version must be one of 5.6, 7.0, 7.1, 7.2, 7.3 or 7.4"
            ;;
    esac
fi
...
if [ $phpVersionNum -lt 50600 -o $phpVersionNum -gt 70499 ]; then
    fatal_error "Only PHP versions 5.6 and 7.0-7.4 are currently supported"
